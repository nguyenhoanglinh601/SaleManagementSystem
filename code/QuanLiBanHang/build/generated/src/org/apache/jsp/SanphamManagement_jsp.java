...
public final class SanphamManagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        var a=document.getElementById(\"formsearch\");\r\n");
      ...
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        function MenuAddncc() {\r\n");
      out.write("        var x = document.getElementById(\"menu-control\");\r\n");
      out.write("        var y = document.getElementById(\"menu-addncc\");\r\n");
      out.write("        var z = document.getElementById(\"menu-back\");\r\n");
      out.write("        var a=document.getElementById(\"formsearch\");\r\n");
      out.write("        if (x.style.display === \"none\") {\r\n");
      out.write("             x.style.display = \"block\";\r\n");
      ...
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        function BackButton() {\r\n");
      out.write("        var x = document.getElementById(\"menu-control\");\r\n");
      out.write("        var y = document.getElementById(\"menu-add\");\r\n");
      out.write("        var z = document.getElementById(\"menu-back\");\r\n");
      out.write("        var a=document.getElementById(\"formsearch\");\r\n");
      out.write("        var b=document.getElementById(\"menu-addncc\");\r\n");
      out.write("        if (x.style.display === \"none\") {\r\n");
      out.write("             x.style.display = \"block\";\r\n");
      ...
      out.write("        var x = document.getElementById(\"searchoption\");\r\n");
      out.write("        var ten=document.getElementById(\"searchname\");\r\n");
      out.write("        var id=document.getElementById(\"searchid\");\r\n");
      out.write("        var ngay=document.getElementById(\"searchngay\");\r\n");
      out.write("        var gia=document.getElementById(\"searchname\");\r\n");
      out.write("        var ncc=document.getElementById(\"searchncc\");\r\n");
      out.write("        var loai=document.getElementById(\"searchloai\");\r\n");
      out.write("        //tên\r\n");
      out.write("        if (x.value === \"ten\") {\r\n");
      out.write("             ten.style.display = \"block\";\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("                ten.style.display = \"none\";\r\n");
      out.write("            }\r\n");
      out.write("        if (x.value === \"id\") {\r\n");
      out.write("             id.style.display = \"block\";\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("                id.style.display = \"none\";\r\n");
      out.write("            }\r\n");
      out.write("        if (x.value === \"ncc\") {\r\n");
      out.write("             ncc.style.display = \"block\";\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("                ncc.style.display = \"none\";\r\n");
      out.write("            }\r\n");
      out.write("        if (x.value === \"loai\") {\r\n");
      out.write("             loai.style.display = \"block\";\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("                loai.style.display = \"none\";\r\n");
      out.write("            }\r\n");
      out.write("        if (x.value === \"ngaynhap\") {\r\n");
      out.write("             ngay.style.display = \"block\";\r\n");
      out.write("            }\r\n");
      out.write("            else{\r\n");
      out.write("                ngay.style.display = \"none\";\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("</script>\r\n");
 ...
 if(session.getAttribute("them")!=null){ 
      out.write("\r\n");
      out.write("<script>alert(\"Thêm thành công\");</script>\r\n");
 ...
 if(session.getAttribute("capnhat")!=null){ 
      out.write("\r\n");
      out.write("<script>alert(\"Cập nhật thành công\");</script>\r\n");
 ...
 if(session.getAttribute("ncc")!=null)
   { 
      ...
      out.write("\r\n");
      out.write("<script>alert(\"Thêm nhà cung cấp thành công\");</script>\r\n");
 session.removeAttribute("ncc");} 
else{ 
      out.write("\r\n");
      out.write("<script>alert(\"Nhà cung cấp bị trùng\");</script>\r\n");
 session.removeAttribute("ncc");}} 
      out.write("\r\n");
      out.write("<!--tạo hiệu ứng -->\r\n");
      ...
      out.write("                \r\n");
      out.write("                \r\n");
      out.write("                 <!--MENU TÌM KIẾM-------------------------------------------------------------------------------------------------------------------->\r\n");
      out.write("                <div class=\"center\">\r\n");
      out.write("                    <form action=\"sanphamSearchController\" method=\"GET\" id=\"formsearch\">\r\n");
      out.write("                    <b>TÌM KIẾM SẢN PHẨM THEO</b>\r\n");
      out.write("                    <br>\r\n");
      out.write("                    <select id=\"searchoption\" name=\"searchoption\" onchange=\"SearchType()\">\r\n");
      out.write("                        <option value=\"\" selected>\r\n");
      out.write("                            Tìm kiếm Theo\r\n");
      out.write("                        </option>\r\n");
      out.write("                        <option value=\"ten\">\r\n");
      out.write("                            Tên\r\n");
      out.write("                        </option>\r\n");
      out.write("                        <option value=\"id\">\r\n");
      out.write("                            ID\r\n");
      out.write("                        </option>\r\n");
      out.write("                        <option value=\"ncc\">\r\n");
      out.write("                            Nhà Cung Cấp\r\n");
      out.write("                        </option>\r\n");
      out.write("                        <option value=\"loai\">\r\n");
      out.write("                            Loại\r\n");
      out.write("                        </option>\r\n");
      out.write("                        <option value=\"ngaynhap\">\r\n");
      out.write("                            Ngày nhập\r\n");
      out.write("                        </option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                    <br>\r\n");
      out.write("                    <div class=\"count-center\" id=\"searchloai\" style=\"display: none\"><input class=\"informationSearch\" type=\"text\" name=\"searchloai\" placeholder=\"Nhập loại sản phẩm\"></div>\r\n");
      out.write("                    \r\n");
      out.write("                    <div class=\"count-center\" id=\"searchid\" style=\"display: none\"><input class=\"informationSearch\" type=\"text\" name=\"searchID\" placeholder=\"Nhập ID sản phẩm\" ></div>\r\n");
      out.write("                    \r\n");
      out.write("                    <div class=\"count-center\" id=\"searchname\" style=\"display: none\"><input class=\"informationSearch\" type=\"text\" name=\"searchname\" placeholder=\"Nhập tên sản phẩm\" ></div>\r\n");
      out.write("                   \r\n");
      out.write("                    <div class=\"count-center\" id=\"searchncc\" style=\"display: none\">\r\n");
      out.write("                    \r\n");
      out.write("                    <select name=\"searchncc\" class=\"information\">\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("                    \r\n");
      out.write("                    <div style=\"display: none\" id=\"searchngay\"> Từ <br> <input class=\"informationSearch\" type=\"date\" name=\"searchstart\" placeholder=\"Nhập ngày bắt đầu\"><br>Đến <br>\r\n");
      out.write("                     \r\n");
      out.write("                        <input class=\"informationSearch\" type=\"date\" name=\"searchend\" placeholder=\"Nhập ngày kết thúc\"></div>\r\n");
      out.write("                      \r\n");
      out.write("                        <br> <input class=\"searchProduct\" type=\"submit\" value=\"Tìm Kiếm\" name=\"searchProduct\" >\r\n");
      out.write("                    \r\n");
      out.write("                    </form>\r\n");
      out.write("                </div>\r\n");
      out.write("                <hr>\r\n");
      ...
      out.write("                \r\n");
      out.write("                \r\n");
      out.write("                <!--MENU CHỨC NĂNG-------------------------------------------------------------------------------------------------------------------->\r\n");
      out.write("                <div id=\"menu-control\">\r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    Option\r\n");
      out.write("                </div>\r\n");
      out.write("                    <input class=\"addProduct\" type=\"submit\" onclick=\"MenuAdd();\" value=\"Thêm Sản Phẩm\">\r\n");
      out.write("                     <input class=\"addProduct\" type=\"submit\" onclick=\"MenuAddncc();\" value=\"Thêm nhà cung cấp\">\r\n");
      out.write("                     <form action=\"sanphamSearchController\" method=\"POST\"><input class=\"addProduct\" type=\"submit\" name=\"hanhdong\" value=\"Làm mới danh sách\"></form>\r\n");
      out.write("                     <form action=\"sanphamEXPORTController\" method=\"GET\"> \r\n");
      out.write("                        <input type=\"text\" class=\"information\" accepted=\".xls\" name=\"filepath\" placeholder=\"Nhập đường dẫn file\" > <br>\r\n");
      out.write("                        <input type=\"submit\" class=\"searchProduct\" onclick=\"\" value=\"Export\" name=\"hanhdong\" value=\"Export\"></input><input class=\"searchProduct\" name=\"hanhdong\" type=\"submit\" onclick=\"\" value=\"Import\"/>\r\n");
      out.write("                    </form>\r\n");
      out.write("                </div>\r\n");
      out.write("                \r\n");
      out.write("                \r\n");
      ...
      out.write("              \r\n");
      out.write("              \r\n");
      out.write("               <!--THÊM NHÀ CUNG CẤP-------------------------------------------------------------------------------------------------------------------->\r\n");
      out.write("              <form action=\"nhacungcapAddController\" method=\"POST\" style=\"display: none\" id=\"menu-addncc\">\r\n");
      out.write("                <div class=\"center\">\r\n");
      out.write("                    <b>THÊM MỚI NHÀ CUNG CẤP</b>\r\n");
      out.write("                </div>\r\n");
      out.write("                \r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    <input class=\"information\" type=\"text\" name=\"NameProducer\" placeholder=\"Nhập tên nhà cung cấp\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("                    <br>\r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    <input class=\"information\" type=\"text\" name=\"SDTProducer\" placeholder=\"Nhập số điện thoại\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("                <br>                        \r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    <input class=\"information\" type=\"text\" name=\"DiaChiProducer\" placeholder=\"Nhập Địa chỉ\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("                <br>                        \r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    <input class=\"information\" type=\"text\" name=\"EmailProducer\" placeholder=\"Nhập Email\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("                <br>\r\n");
      out.write("                <div class=\"count-center\">\r\n");
      out.write("                    <input class=\"addProduct\" type=\"submit\" name=\"addProduct\" value=\"Thêm\">\r\n");
      ...
      out.write("                    <input class=\"backbutton\" type=\"submit\" name=\"addProduct\" value=\"<-\" onclick=\"BackButton();\" >\r\n");
      out.write("                </div> \r\n");
      out.write("                <!--nút back-------------------------------------------------------------------------------------------------------------------->\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
