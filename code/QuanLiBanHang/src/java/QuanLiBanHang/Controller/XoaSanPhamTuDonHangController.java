 ...
 * @author user
 */
@WebServlet(name = "XoaSanPhamTuDonHangController", urlPatterns = {"/XoaSanPhamTuDonHangController"})
public class XoaSanPhamTuDonHangController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (MatHang mathang : DanhSachMatHang) {
            index++;
            if(mathang.getMaMatHang()==id){
                break;
            }
        }
        DanhSachMatHang.remove(index-1);
